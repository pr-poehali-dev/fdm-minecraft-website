...
const History = () => {
  ...
  const legendaryPlayers = [
    ...
    {
      name: "Hemister_Hunter",
      role: "Нынешний глава Красного Рассвета",
      story: "Современный лидер легендарного клана, принявший эстафету после Lyntik7884 и lopalopa. Продолжает традиции великих предшественников, управляя крупнейшим кланом сервера с 127 участниками. В его руках находится судьба самой мощной силы Freedom, и он достойно несёт бремя ответственности за наследие, созданное основателями клана на протяжении многих лет существования сервера.",
      icon: "Shield",
